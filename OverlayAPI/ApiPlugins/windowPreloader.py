...
class WindowPreLoader(PreLoader):
    @classmethod
    def getConfigSetting(cls, module):
        settingConfig = super().getConfigSetting(module)
        if settingConfig is None:
            from API.OWindow.pluginSettingWindow import WindowSettingConfigData
            return WindowSettingConfigData
